 ...
 <footer>
   <div class="content">
       ...
       <div class="lower">
         ...
         <?php
          foreach ($category as $value) {
            ...
            <a href="others/user_category_page.php?category='.$value['id'].'">'.$value['category_name'].'</a>
            </div>';
          }
         ?>
       </div>
     ...
     <div class="middle box">
       ...
       <div><a href="others/user_setting.php">User Setting</a></div>
       <div><a href="others/user_cart.php">Cart</a></div>
       <div><a href="others/seller_page.php">Seller</a></div>
     </div>
     <div class="right box">
